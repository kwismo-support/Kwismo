    ...
    <View className="z-50 relative">
      <View
        style={{
          ...
          paddingBottom: isSearchActive ? 14 : 30,
        }}
      ...
      >
        ...
        {isSearchActive ? (
          <View className="flex-row items-center justify-between min-h-7 mb-2">
            <View className="flex-1 flex-row items-center bg-white/20 rounded-full px-3 py-1.5 mr-2">
        ...
        {!isSearchActive && !showBack && subtitle && (
          <View className="items-center justify-center">
      ...
      {isSearchActive && (
        <Animated.View
          ...
          style={{
            position: 'absolute',
            top: headerHeightTop + 54,
            left: 0,
            right: 0,
            height: 1000,
            zIndex: 999,
          }}
          className="bg-white dark:bg-brand-darkBg px-4 pt-3"
        >
          <View className="mb-3">
            <Text className="font-headline-bold text-2xs text-slate-400 dark:text-slate-400 uppercase tracking-widest mb-2">
