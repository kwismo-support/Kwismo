  ...
  return (
    <>
      ...
      >
        ...
        <View className={`flex-row items-center justify-between min-h-7 ${showBack ? 'mb-3' : 'mb-8'}`}>
          {showBack ? (
            <>
        ...
        {showBack && title ? (
          <View className="items-center justify-center pb-1">
            <Text
              ...
              className="font-montserrat-bold text-2xl font-bold text-center"
            >
              {title}
            </Text>
          </View>
