...
export const SplashBackgroundDecorations: React.FC = () => {
  return (
    <View className="absolute inset-0 pointer-events-none">
      <Svg className="absolute -top-5 -right-5" width="220" height="220" viewBox="0 0 200 200">
        <Path
      ...
      <Svg className="absolute -bottom-8 -right-8" width="260" height="260" viewBox="0 0 200 200">
        <Path
      ...
      <Svg className="absolute top-[40%] -left-10" width="160" height="160" viewBox="0 0 160 160">
        <Path
      ...
      <Svg className="absolute bottom-5 -left-5" width="160" height="160" viewBox="0 0 160 160">
        <Path
          d="M 80 20 Q 80 80 20 80 Q 80 80 80 140 Q 80 80 140 80 Q 80 80 80 20 Z"
...
export default SplashBackgroundDecorations;
