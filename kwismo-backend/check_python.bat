...
REM Verifie que Python 3.13 est installe avant de demarrer KWISMO Backend.
REM A lancer en premier (double-clic ou depuis un terminal), avant toute
REM autre commande (creation du venv, pip install, prisma...).
...
if errorlevel 1 (
    ...
    echo.
    echo   KWISMO Backend necessite Python 3.13 pour demarrer.
